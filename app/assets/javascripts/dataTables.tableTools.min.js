    ...
    var r = function (n) {
        ...
        g.Client.prototype = {id: 0, ready: !1, movie: null, clipText: "", fileName: "", action: "copy", handCursorEnabled: !0, cssEffects: !0, handlers: null, sized: !1, glue: function (a, b) {
            ...
            if (this.handlers[a])for (var d = 0, f = this.handlers[a].length; d <
                ...
                if ("function" == typeof e)e(this, b); else if ("object" == typeof e && 2 == e.length)e[0][e[1]](this, b); else if ("string" == typeof e)m[e](this, b)
            }
        }};
        ...
        TableTools.prototype = {fnGetSelected: function (a) {
                ...
                e(b.nTBody).on("click.DTTT_Select", this.s.custom.sRowSelector, function (c) {
                    ...
                    if (d.parentNode ==
                        ...
                        if (f.type == "os")if (c.ctrlKey || c.metaKey)a.fnIsSelected(d) ? a._fnRowDeselect(d, c) : a._fnRowSelect(d, c); else if (c.shiftKey) {
                            ...
                            if (a.fnGetSelected().length === 0 || h === -1)j.splice(e.inArray(i, j) + 1, j.length); else {
            ...
            for (f in d)if ("i" != f && "t" != f && 1 == f.length)for (var i = 0, g = d[f].length; i < g; i++)this.dom.print.hidden.push({node: d[f][i], display: "block"}), d[f][i].style.display = "none";
